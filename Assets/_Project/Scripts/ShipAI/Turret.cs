...
namespace Weapons
{
    public class Turret : MonoBehaviour
    {
        ...
        public List<TargetPriority> TargetPriorities { get; protected set; } = new()
        {
            new(ObjectType.Planet,0),new(ObjectType.Asteroid,0)
        };
        private void Awake()
        {
        ...
        {
            targetStrategy.ConsiderTarget(@object);
        }
        public void Fire()
        {
